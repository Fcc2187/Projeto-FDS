...
class AdicionarNoCarrinho(LiveServerTestCase):
    ...
    def test_cenario1_and_2(self):
        ...
        botao2.send_keys(Keys.ENTER)
        time.sleep(2)
        botaoadd = driver.find_element(by=By.XPATH, value="/html/body/div/div[1]/div/div[2]/div/center/button[1]")
...
class GerenciarCarrinho(LiveServerTestCase):
    ...
    def test_cenario1(self):
        ...
        time.sleep(2)
        botaoupdate = driver.find_element(by=By.XPATH, value="/html/body/div/div/div/div[2]/div/center/button[1]")
